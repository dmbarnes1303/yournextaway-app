...
munich: {
  ...
  name: "Munich",
  country: "Germany",
  tripAdvisorTopThingsUrl: "https://www.tripadvisor.com/Attractions-g187309-Activities-Munich_Upper_Bavaria_Bavaria.html",
  overview:
...
dortmund: {
  ...
  name: "Dortmund",
  country: "Germany",
  tripAdvisorTopThingsUrl: "https://www.tripadvisor.com/Attractions-g187372-Activities-Dortmund_North_Rhine_Westphalia.html",
  overview:
...
sinsheim: {
  ...
  name: "Sinsheim",
  country: "Germany",
  tripAdvisorTopThingsUrl: "https://www.tripadvisor.com/Attractions-g198540-Activities-Sinsheim_Baden_Wurttemberg.html",
  overview:
  ...
  name: "Leipzig",
  country: "Germany",
  tripAdvisorTopThingsUrl: "https://www.tripadvisor.com/Attractions-g187400-Activities-Leipzig_Saxony.html",
  overview:
...
stuttgart: {
  ...
  name: "Stuttgart",
  country: "Germany",
  tripAdvisorTopThingsUrl: "https://www.tripadvisor.com/Attractions-g187291-Activities-Stuttgart_Baden_Wurttemberg.html",
  overview:
...
leverkusen: {
  ...
  name: "Leverkusen",
  country: "Germany",
  tripAdvisorTopThingsUrl: "https://www.tripadvisor.com/Attractions-g187377-Activities-Leverkusen_North_Rhine_Westphalia.html",
  overview:
  ...
  country: "Germany",
  tripAdvisorTopThingsUrl: "https://www.tripadvisor.com/Attractions-g187279-Activities-Freiburg_im_Breisgau_Baden_Wurttemberg.html",
  overview:
...
frankfurt: {
  ...
  name: "Frankfurt",
  country: "Germany",
  tripAdvisorTopThingsUrl: "https://www.tripadvisor.com/Attractions-g187337-Activities-Frankfurt_Hesse.html",
  overview:
  ...
  topThings: [
    {
      title: "Römerberg & Old Town reconstruction",
      tip: "Start here to anchor yourself. It’s compact, photogenic, and gives instant sense of place.",
    },
    {
      title: "Main Tower observation deck",
      tip: "Best skyline view in Frankfurt. Go on a clear day. Late afternoon into dusk is ideal.",
    },
    {
      title: "River Main promenade walk",
      tip: "Walk between Eiserner Steg and Museumsufer. Flat, scenic, and good pacing between attractions.",
    },
    {
      title: "Museumsufer (choose one museum)",
      tip: "Städel Museum is the strongest all-round choice. Pick one — don’t attempt a museum crawl.",
    },
    {
      title: "Sachsenhausen apple wine district",
      tip: "Traditional taverns, hearty food, and local Apfelwein. Great pre-match or evening block.",
    },
    {
      title: "Zeil shopping street",
      tip: "Not a destination in itself, but useful for supplies and quick browsing.",
    },
    {
      title: "Eintracht Frankfurt matchday (Deutsche Bank Park)",
      tip: "One of Germany’s best atmospheres. Arrive early, walk around stadium, and expect intense noise levels once inside.",
    },
    {
      title: "Day trip: Mainz or Wiesbaden",
      tip: "Both reachable in under 40 minutes and excellent for wine, old towns, and relaxed strolling.",
    },
    {
      title: "Skyline Plaza rooftop",
      tip: "Free alternative viewpoint if you don’t want to pay for Main Tower.",
    },
    {
      title: "Palmengarten (botanical gardens)",
      tip: "Good calm block if you want green space away from the city core.",
    },
  ],
  tips: [
...
berlin: {
  ...
  topThings: [
    {
      title: "Brandenburg Gate & Pariser Platz",
      tip: "Early morning or late evening for fewer crowds and better photos.",
    },
    {
      title: "Reichstag dome",
      tip: "Book ahead. Sunset slot if possible.",
    },
    {
      title: "Berlin Wall Memorial (Bernauer Straße)",
      tip: "Most powerful open-air history site. Give it real time.",
    },
    {
      title: "East Side Gallery",
      tip: "Walk the full stretch, then move on — it’s long but linear.",
    },
    {
      title: "Museum Island (pick one museum)",
      tip: "Pergamon or Neues Museum are strong choices.",
    },
    {
      title: "Kreuzberg & Neukölln food districts",
      tip: "Excellent for casual eating, late-night snacks, and bars.",
    },
    {
      title: "Tempelhofer Feld",
      tip: "Former airport turned giant park. Bike, walk, or just sit and watch the city.",
    },
    {
      title: "Olympiastadion matchday (Hertha BSC)",
      tip: "Huge stadium, Olympic history, and big-match feel.",
    },
    {
      title: "Stadion An der Alten Försterei matchday (Union Berlin)",
      tip: "One of Europe’s most atmospheric grounds. Arrive very early.",
    },
    {
      title: "Prenzlauer Berg cafés & bars",
      tip: "Relaxed daytime base and good evening food scene.",
    },
  ],
  tips: [
  ...
  name: "Cologne",
  country: "Germany",
  tripAdvisorTopThingsUrl: "https://www.tripadvisor.com/Attractions-g187371-Activities-Cologne_North_Rhine_Westphalia.html",
  overview:
  ...
  topThings: [
    ...
    {
      title: "Old Town (Altstadt) riverside walk",
      tip: "Walk along the Rhine between Hohenzollern Bridge and Heumarkt. Great for photos, casual bars, and people-watching.",
    },
    {
      title: "Hohenzollern Bridge love locks",
      tip: "Classic quick stop while crossing the Rhine. Combine with river promenade walk.",
    },
    {
      title: "Belgian Quarter (Belgisches Viertel)",
      tip: "Best area for independent shops, cafés, and bars. Strong evening base.",
    },
    {
      title: "Cologne Chocolate Museum",
      tip: "Touristy but genuinely fun and central. Good rainy-day option.",
    },
    {
      title: "Museum Ludwig",
      tip: "Strong modern art collection if you want one cultural stop.",
    },
    {
      title: "1. FC Köln matchday (RheinEnergieStadion)",
      tip: "Arrive early. Pre-match Kölsch beers around the stadium area are part of the ritual.",
    },
    {
      title: "Kölsch beer halls",
      tip: "Drink Kölsch the local way — small glasses that keep arriving until you put your coaster on top.",
    },
    {
      title: "Rhine boat cruise (short version)",
      tip: "Good relaxed sightseeing if weather is decent.",
    },
    {
      title: "Day trip: Düsseldorf or Bonn",
      tip: "Both under 40 minutes by train. Easy add-ons if staying multiple nights.",
    },
  ],
  tips: [
...
monchengladbach: {
  ...
  country: "Germany",
  tripAdvisorTopThingsUrl: "https://www.tripadvisor.com/Attractions-g187384-Activities-Monchengladbach_North_Rhine_Westphalia.html",
  overview:
  ...
  topThings: [
    {
      ...
      tip: "If available, worth doing. Gives context to one of Germany’s historic clubs.",
    },
    {
      title: "Borussia Mönchengladbach matchday",
      tip: "Strong atmosphere, family-friendly but passionate. Arrive early for fan zones.",
    },
    {
      title: "Abteiberg Museum",
      tip: "Modern art in an interesting building. Good cultural filler.",
    },
    {
      title: "Bunter Garten park",
      tip: "Large green space near city centre. Nice calm block.",
    },
    {
      title: "Old Town (Alter Markt & Waldhausener Straße)",
      tip: "Main nightlife spine with bars, pubs, and casual restaurants. Best evening base if staying overnight.",
    },
    {
      title: "Schloss Rheydt (Rheydt Palace)",
      tip: "Well-preserved Renaissance palace on the edge of the city. Short cultural stop if you want something beyond football.",
    },
    {
      title: "Day trip: Cologne or Düsseldorf",
      tip: "Both 30–45 minutes by train. Many fans base themselves in those cities and travel in for matches.",
    },
    {
      title: "Pre-match fan pubs",
      tip: "Look for supporter-heavy pubs in the city centre before heading to the stadium by shuttle or bus.",
    },
  ],
  tips: [
...
wolfsburg: {
  ...
  name: "Wolfsburg",
  country: "Germany",
  tripAdvisorTopThingsUrl: "https://www.tripadvisor.com/Attractions-g187348-Activities-Wolfsburg_Lower_Saxony.html",
  overview:
  ...
  topThings: [
    {
      title: "Volkswagen Autostadt",
      tip: "Huge automotive theme park, museum complex, and delivery centre. Even non-car obsessives find it impressive. Allow at least half a day.",
    },
    {
      title: "Volkswagen Arena matchday",
      tip: "Stadium sits next to Autostadt. Arrive early, walk around the complex, and soak in the build-up.",
    },
    {
      title: "Phaeno Science Center",
      tip: "Hands-on science museum with striking architecture. Good daytime filler.",
    },
    {
      title: "Allerpark lakeside area",
      tip: "Green space, lake walks, cafés, and casual dining. Nice contrast to the industrial roots.",
    },
    {
      title: "Wolfsburg Castle",
      tip: "Historic anchor of the city with museum spaces and parkland.",
    },
    {
      title: "Designer Outlets Wolfsburg",
      tip: "Large outlet mall near station. Useful shopping stop if you have time.",
    },
    {
      title: "City Centre pedestrian zone",
      tip: "Compact modern centre for food, supplies, and casual wandering.",
    },
    {
      title: "Pre-match fan areas",
      tip: "Fan zones around the stadium and Autostadt concentrate atmosphere — don’t hide in the city centre.",
    },
    {
      title: "Day trip: Braunschweig",
      tip: "25 minutes by train. More traditional historic city if you want extra sightseeing.",
    },
    {
      title: "Evening bars near station",
      tip: "Limited but functional nightlife clustered around central area.",
    },
  ],
  tips: [
  ...
  name: "Augsburg",
  country: "Germany",
  tripAdvisorTopThingsUrl: "https://www.tripadvisor.com/Attractions-g187410-Activities-Augsburg_Swabia_Bavaria.html",
  overview:
  ...
  topThings: [
    {
      title: "Fuggerei (world’s oldest social housing complex)",
      tip: "This is Augsburg’s signature ‘only here’ attraction. Go early or late afternoon for fewer crowds, and actually take time to read the history — it’s not just a photo stop. The museum house gives context and makes it far more memorable.",
    },
    {
      title: "Augsburg Old Town (Rathausplatz + streets around it)",
      tip: "Base yourself around Rathausplatz: the Town Hall (Rathaus), Perlachturm area, and surrounding lanes give you the best ‘Augsburg feel’ with minimal effort. Do a slow loop, grab a coffee, then repeat in the evening when it’s quieter and prettier.",
    },
    {
      title: "Augsburg Town Hall (Rathaus) & Golden Hall",
      tip: "If it’s open, it’s worth it — the Golden Hall is exactly the kind of ‘surprisingly impressive’ interior you don’t expect until you’re standing inside it. Pair with a short wander through the square and nearby courtyards.",
    },
    {
      title: "Canal district & Lechviertel walk",
      tip: "Augsburg’s little canals and bridges are what give it charm beyond the main squares. Walk through Lechviertel and let yourself get slightly lost — it’s compact and safe, and it feels genuinely local.",
    },
    {
      title: "Augsburg Cathedral (Dom) + historic core",
      tip: "It’s not a ‘must’ like Cologne’s cathedral, but it’s a calm, beautiful stop and helps balance a weekend that otherwise becomes beer/football-heavy. Best as a quiet morning block.",
    },
    {
      title: "Schaezlerpalais",
      tip: "For a quick culture hit: elegant interiors and art collection. It’s a strong rainy-day choice and gives a ‘grand’ contrast to Augsburg’s everyday streets.",
    },
    {
      title: "FC Augsburg matchday (WWK ARENA)",
      tip: "Arrive early and treat the stadium area as part of the event. The club isn’t a global giant, but matchdays have a proper Bundesliga feel — especially if you make time for pre-match food and a couple of beers rather than arriving last-minute.",
    },
    {
      title: "Botanical Garden (if in season)",
      tip: "If the weather is good and you want a calmer block, it’s an excellent reset. This is more of a ‘nice add-on’ than a priority, but it’s genuinely pleasant.",
    },
    {
      title: "Beer halls + Bavarian-Swabian dining",
      tip: "Don’t waste time hunting for trendy spots. Augsburg is at its best in solid, traditional places: hearty food, local beer, easy atmosphere. Go where it’s busy with locals.",
    },
    {
      title: "Day trip option: Munich (if you need a big-city add-on)",
      tip: "Augsburg–Munich is fast by train, so you can keep Augsburg as your base for value and calm, then dip into Munich for one heavy sightseeing block if you want.",
    },
  ],
  tips: [
...
hamburg: {
  ...
  name: "Hamburg",
  country: "Germany",
  tripAdvisorTopThingsUrl: "https://www.tripadvisor.com/Attractions-g187331-Activities-Hamburg.html",
  overview:
  ...
  topThings: [
    {
      title: "Harbor & Landungsbrücken waterfront walk",
      tip: "Do this early to get the city’s maritime identity immediately. Walk the promenade, watch the boats, then grab a fish sandwich — it’s a classic Hamburg ‘set the tone’ block.",
    },
    {
      title: "Miniatur Wunderland",
      tip: "It sounds childish until you’re in there — it’s genuinely one of Europe’s best ‘indoor attractions’. Book a timed slot if possible and go off-peak; weekends can be brutally busy.",
    },
    {
      title: "Speicherstadt & HafenCity (architecture + canals)",
      tip: "This is Hamburg’s most photogenic zone: brick warehouses, waterways, and modern waterfront development. Best in soft light (morning/evening) and perfect for a slow wander.",
    },
    {
      title: "Elbphilharmonie Plaza",
      tip: "Even if you’re not seeing a concert, go up to the public plaza for views. Book free/low-cost access ahead when possible to avoid queues.",
    },
    {
      title: "Reeperbahn & St. Pauli nightlife strip",
      tip: "Don’t treat it like a single ‘party street’. Use it as a base, then branch into side streets and bars with actual vibe. Go late — Hamburg nights start later than you think.",
    },
    {
      title: "St. Pauli district (daytime culture + bars)",
      tip: "Go before the nightlife. Street art, cafés, and the district identity make more sense in daylight. It’s also a strong pre-match area.",
    },
    {
      title: "St. Pauli matchday (Millerntor-Stadion)",
      tip: "This is a bucket-list football experience because it’s embedded in the city. Build it properly: pre-match beers locally, walk to the stadium with the crowd, then stay around afterwards rather than sprinting away.",
    },
    {
      title: "HSV matchday (Volksparkstadion)",
      tip: "Bigger stadium, bigger-club feel. Logistics matter more because it’s not in the middle of the nightlife district. Plan transport and a post-match return route.",
    },
    {
      title: "Alster Lakes (Binnenalster/ Außenalster)",
      tip: "For a calmer ‘reset’ block, walk around the Alster. It balances the port grit and nightlife with something clean and peaceful.",
    },
    {
      title: "Fischmarkt (Sunday morning, if you can handle it)",
      tip: "If you’re up for it, it’s a famously messy Hamburg experience. Expect early start, crowds, and a slightly chaotic vibe — but it’s memorable. If you hate chaos, skip it without guilt.",
    },
  ],
  tips: [
...
bremen: {
  ...
  name: "Bremen",
  country: "Germany",
  tripAdvisorTopThingsUrl: "https://www.tripadvisor.com/Attractions-g187325-Activities-Bremen.html",
  overview:
  ...
  topThings: [
    {
      title: "Marktplatz (Market Square) + Bremen Town Hall",
      tip: "This is Bremen’s ‘wow’ centre — the Town Hall is UNESCO-listed and the square feels properly historic. Go early for photos, then return at night when it’s calmer and beautifully lit.",
    },
    {
      title: "Roland Statue",
      tip: "Quick but iconic. It’s part of the Marktplatz cluster — don’t overthink it, just absorb the setting and move on.",
    },
    {
      title: "Schnoor Quarter (oldest district)",
      tip: "Narrow lanes, tiny houses, boutique shops — it’s the most atmospheric place in Bremen. Best done as a slow wander with coffee stops rather than rushing through for photos.",
    },
    {
      title: "Böttcherstraße",
      tip: "Short street but very distinctive architecture and craft vibe. Perfect ‘10–20 minute high-impact’ stop.",
    },
    {
      title: "Weser riverside walk",
      tip: "Walk along the river to feel Bremen’s rhythm. It’s especially good on a match weekend because it ties the city and stadium together naturally.",
    },
    {
      title: "Werder Bremen matchday (Weserstadion)",
      tip: "One of the best stadium settings in Germany because of the river location. Arrive early and approach on foot — it makes the whole matchday feel like an event, not a commute.",
    },
    {
      title: "Bürgerpark (if you want green space)",
      tip: "Large park that’s perfect as a calm block to reset your energy, especially if you’ve had a heavy night or a long travel day.",
    },
    {
      title: "Übersee-Museum (rainy-day option)",
      tip: "If the weather is grim, this is a solid ‘fill 1–2 hours with substance’ museum without needing deep planning.",
    },
    {
      title: "Beer halls / local pubs",
      tip: "Bremen is best when you go simple: busy, local-feeling places near the centre. You’ll get better atmosphere than chasing ‘top-rated tourist restaurants’.",
    },
    {
      title: "Day trip option: Hamburg",
      tip: "If you want to blend a calm Bremen base with one high-energy day, Hamburg is reachable by train — but Bremen alone is strong enough for a full weekend.",
    },
  ],
  tips: [
  ...
  name: "Mainz",
  country: "Germany",
  tripAdvisorTopThingsUrl: "https://www.tripadvisor.com/Attractions-g187372-Activities-Mainz_Rhineland_Palatinate.html",
  overview:
  ...
  topThings: [
    {
      title: "Mainz Old Town (Altstadt) wander",
      tip: "Mainz is best done as a slow roam: half-timbered houses, small squares, local shops, and bars tucked into side streets. Don’t try to ‘route plan’ it too much — pick a starting point near the cathedral, then drift.",
    },
    {
      title: "Mainz Cathedral (Dom St. Martin)",
      tip: "This is the historic anchor. Go inside for 15–30 minutes, then use the surrounding streets as your base for food and drinks. It’s central, so it naturally connects to everything else.",
    },
    {
      title: "Rheinpromenade riverside walk",
      tip: "Do a Rhine walk to reset your head — especially if you’ve travelled in that day. Late afternoon is ideal: good light, calmer vibe, and it sets you up perfectly for dinner and evening drinks.",
    },
    {
      title: "Gutenberg Museum / Gutenberg history",
      tip: "Mainz is the Gutenberg city. If you want one “proper culture” block, this is the one. Check opening status before you build the day around it (museum access can vary), but when it’s available it adds real substance to your trip beyond football.",
    },
    {
      title: "Augustinerstraße & the ‘classic Mainz lanes’",
      tip: "This street and the surrounding area are where Mainz feels most like itself — photogenic but still local. It’s an easy win for atmosphere and a good place to pause for a drink.",
    },
    {
      title: "Wine taverns (Weinstuben) + local white wines",
      tip: "Mainz is a Rhine wine city. Don’t just default to beer — try local Riesling and regional whites in a proper Weinstube. The vibe is relaxed and perfect for pre-match or post-match wind-down.",
    },
    {
      title: "1. FSV Mainz 05 matchday (MEWA ARENA)",
      tip: "Mainz matchdays are approachable and efficient — a huge plus for travellers. Arrive early, do a pre-match drink/meal in town, then head out with time to spare so you’re not rushing. The experience is much better when you treat it as a full afternoon/evening, not a last-minute dash.",
    },
    {
      title: "Day trip: Rhine river towns (Bingen, Rüdesheim, etc.)",
      tip: "If you’ve got an extra day, the Rhine is right there. Short trips to classic river scenery and wine towns are easy and turn Mainz into a ‘football + Rhine mini-break’ rather than just a match stop.",
    },
    {
      title: "Day trip: Frankfurt (big-city bolt-on)",
      tip: "If you want a ‘big city’ block (skyscraper views, shopping, museums), Frankfurt is close. Mainz lets you sleep somewhere calmer and cheaper, then dip into Frankfurt when you choose.",
    },
    {
      title: "Chilled café culture + people-watching",
      tip: "Mainz is underrated for just sitting and enjoying the day. Build at least one low-pressure hour into your trip — coffee, pastries, a slow stroll — it makes the whole weekend feel like a break.",
    },
  ],
  tips: [
...
heidenheim: {
  ...
  country: "Germany",
  tripAdvisorTopThingsUrl: "https://www.tripadvisor.com/Attractions-g198583-Activities-Heidenheim_an_der_Brenz_Baden_Wurttemberg.html",
  overview:
  ...
  topThings: [
    {
      title: "1. FC Heidenheim matchday (Voith-Arena)",
      tip: "This is the whole point — a top-flight matchday in a smaller city where the club feels like the community. Arrive early, soak up the local pre-match vibe, and don’t treat it like a last-minute stadium dash. The ‘small club, big moment’ energy is what makes this trip special.",
    },
    {
      title: "Schloss Hellenstein (Hellenstein Castle) viewpoint",
      tip: "This is your best ‘Heidenheim signature’ stop: great views and a strong sense of place. Go in daylight for scenery, or late afternoon if you want golden light. It’s the kind of simple stop that makes the trip feel like a destination, not just a match.",
    },
    {
      title: "Old Town / central walk (small-city pace)",
      tip: "Heidenheim isn’t built for checklist sightseeing — it’s built for calm wandering. Do a short loop through the centre, pick a café, then just let the pace slow down. This is how you make the trip feel like a break.",
    },
    {
      title: "Nature block: Swabian Jura edge (walks + viewpoints)",
      tip: "If you’ve got a spare morning, build in a countryside walk or scenic viewpoint. The region is green and satisfying — even a short nature block changes the feel of the trip and makes it “football + outdoors” rather than “football + hotel room.”",
    },
    {
      title: "Day trip option: Ulm",
      tip: "If you want a bigger ‘city’ hit nearby, Ulm is a strong add-on with the cathedral (Ulm Minster) and a pretty old town feel. This is how you give the weekend more variety without forcing Heidenheim to be something it isn’t.",
    },
    {
      title: "Day trip option: Stuttgart (if you want a major hub)",
      tip: "Stuttgart is the nearest major city option — useful if your flights or trains route through there, or if you want one big-city day and one small-city matchday day. It’s a smart way to combine experiences.",
    },
    {
      title: "Local beer halls / simple German dining",
      tip: "Heidenheim is best when you keep food plans simple and local — hearty German staples, beer, and relaxed service. Don’t waste time hunting for ‘Instagram food’ — it’s not that kind of trip.",
    },
    {
      title: "Pre-match and post-match ritual time",
      tip: "This is where small-city matchdays win: you can actually enjoy the build-up and the unwind without fighting crowds. Plan a pre-match meal and a post-match drink so the day feels full and satisfying.",
    },
    {
      title: "If you want a ‘regional culture’ angle",
      tip: "Lean into Baden-Württemberg / Swabian identity — it’s subtly different from Bavaria or the north. Even just noticing the food and beer style makes the trip feel more ‘German travel experience’ than generic stadium hopping.",
    },
    {
      title: "Slow morning café + ‘reset’ block",
      tip: "This sounds basic, but it’s crucial in a smaller city: give yourself a calm start, then you’ll enjoy the matchday far more. This is how you turn a short trip into something that feels restorative.",
    },
  ],
  tips: [
  ...
  transport:
    "Heidenheim is manageable and straightforward once you’re there, but it’s not a major transport hub — your planning matters more than in big cities. Expect regional trains/buses and build buffer time into connections, especially on match weekends.",
  accommodation:
