...
const GYG = {
  istanbul:
    "https://www.getyourguide.com/en-gb/istanbul-l56/?partner_id=MAQJREP&utm_medium=online_publisher",
  trabzon:
    "https://www.getyourguide.com/en-gb/trabzon-l32545/?partner_id=MAQJREP&utm_medium=online_publisher",
  izmir:
    "https://www.getyourguide.com/en-gb/izmir-l1082/?partner_id=MAQJREP&utm_medium=online_publisher",
  samsun:
    "https://www.getyourguide.com/en-gb/samsun-l99678/?partner_id=MAQJREP&utm_medium=online_publisher",
  ankara:
    "https://www.getyourguide.com/en-gb/ankara-l1236/?partner_id=MAQJREP&utm_medium=online_publisher",
  konya:
    "https://www.getyourguide.com/en-gb/konya-l124282/?partner_id=MAQJREP&utm_medium=online_publisher",
  antalya:
    "https://www.getyourguide.com/en-gb/antalya-l172/?partner_id=MAQJREP&utm_medium=online_publisher",
  kayseri:
    "https://www.getyourguide.com/en-gb/kayseri-l1052/?partner_id=MAQJREP&utm_medium=online_publisher",
  rize:
    "https://www.getyourguide.com/en-gb/rize-l185053/?partner_id=MAQJREP&utm_medium=online_publisher",
  izmit:
    "https://www.getyourguide.com/en-gb/izmit-l164051/?partner_id=MAQJREP&utm_medium=online_publisher",
  gaziantep:
    "https://www.getyourguide.com/en-gb/gaziantep-l157172/?partner_id=MAQJREP&utm_medium=online_publisher",
  alanya:
    "https://www.getyourguide.com/en-gb/alanya-l918/?partner_id=MAQJREP&utm_medium=online_publisher",
} as const;
...
export const superLigCityGuides: Record<string, CityGuide> = {
    ...
    topThings: [
      {
        ...
        tip: "One of the best low-effort ways to understand the city’s scale. Do it early in the trip.",
      },
      {
        title: "Sultanahmet loop",
        tip: "Hit Hagia Sophia, Blue Mosque and the square early before crowds get stupid.",
      },
      {
        title: "Galata & Karaköy",
        tip: "Best for cafés, bars and easy city-break wandering without rigid planning.",
      },
      {
        title: "Kadıköy market streets",
        tip: "Best local-feel food district on the Asian side and ideal around Fenerbahçe trips.",
      },
      {
        title: "Beşiktaş waterfront",
        tip: "Strong pre-match district if you want bars, noise and movement.",
      },
      {
        title: "Balat & Fener",
        tip: "Good for a slower half-day with character rather than headline landmarks.",
      },
      {
        title: "Grand Bazaar",
        tip: "Go with discipline. If you browse aimlessly, you waste hours.",
      },
      {
        title: "Topkapi Palace",
        tip: "Worth it if you actually want history. Don’t force it on a tight football weekend.",
      },
      {
        title: "Rooftop dinner with view",
        tip: "Book one strong dinner instead of three average ones.",
      },
      {
        title: "Neighbourhood pub / meyhane night",
        tip: "The best Istanbul evenings usually come from a good area choice, not from chasing a list.",
      },
    ],
    tips: [
  ...
  trabzon: {
    ...
    topThings: [
      {
        title: "Meydan area walk",
        tip: "This is your practical centre and best general visitor anchor.",
      },
      {
        title: "Trabzon seafront",
        tip: "Best for a calmer reset and easy food stops.",
      },
      {
        title: "Atatürk Mansion",
        tip: "Fine if you have spare time; not essential if football is the priority.",
      },
      {
        title: "Boztepe viewpoint",
        tip: "Good for tea and city views, especially around sunset.",
      },
      {
        title: "Local tea houses",
        tip: "Simple but part of the city rhythm. Don’t overcomplicate it.",
      },
      {
        title: "Fish restaurants",
        tip: "One of the better non-football angles in the city.",
      },
      {
        title: "Central bazaars",
        tip: "Useful for atmosphere, not a whole-day activity.",
      },
      {
        title: "Stadium-area approach",
        tip: "Get there early; let the build-up become part of the experience.",
      },
      {
        title: "Black Sea coastal drive",
        tip: "Only if you have time and transport.",
      },
      {
        title: "Short one-night football stop",
        tip: "Trabzon works very well in compact form.",
      },
    ],
    tips: [
  ...
  izmir: {
    ...
    topThings: [
      {
        title: "Alsancak wander",
        tip: "Best all-round district for bars, food and staying.",
      },
      {
        title: "Kordon seafront",
        tip: "Great for late afternoon into evening. Let it be slow.",
      },
      {
        title: "Konak Square",
        tip: "Useful central reference point, not a huge time sink.",
      },
      {
        title: "Kemeralti Bazaar",
        tip: "Good for atmosphere and snacking; go with purpose.",
      },
      {
        title: "Asansör viewpoint",
        tip: "Short stop, good views, easy add-on.",
      },
      {
        title: "Karşıyaka ferry hop",
        tip: "A nice way to see another side of the city without forcing a big plan.",
      },
      {
        title: "Seafood dinner",
        tip: "Izmir rewards one good evening meal by the water.",
      },
      {
        title: "Coffee and pastry stop in Alsancak",
        tip: "Better use of time than over-chasing attractions.",
      },
      {
        title: "Göztepe matchday build-up",
        tip: "Don’t treat the stadium as a last-minute arrival point.",
      },
      {
        title: "Çeşme add-on",
        tip: "Only if you actually have the time. Don’t dilute the football weekend.",
      },
    ],
    tips: [
    ...
    topThings: [
      {
        ...
        tip: "Best simple walk in the city and ideal for decompressing.",
      },
      {
        title: "Atakum area",
        tip: "Best wider leisure district for cafés and a more open coastal feel.",
      },
      {
        title: "City centre loop",
        tip: "Keep it compact and practical.",
      },
      {
        title: "Amisos Hill / cable car area",
        tip: "Decent short add-on for views if weather is clear.",
      },
      {
        title: "Waterfront dinner",
        tip: "The best non-football move in town.",
      },
      {
        title: "Local café stop",
        tip: "Samsun is a city where small pauses work well.",
      },
      {
        title: "Museum / Atatürk sites",
        tip: "Only if you genuinely want the history layer.",
      },
      {
        title: "Early stadium approach",
        tip: "This is part of the trip here, not something to rush.",
      },
      {
        title: "One-night stop",
        tip: "Samsun often works best in compact form.",
      },
      {
        title: "Seaside morning reset",
        tip: "A strong use of the departure day.",
      },
    ],
    tips: [
  ...
  rize: {
    ...
    topThings: [
      {
        title: "Rize seafront",
        tip: "A clean, low-stress way to feel the city.",
      },
      {
        title: "Tea gardens",
        tip: "Obvious but essential. Don’t come here and ignore the tea angle.",
      },
      {
        title: "City centre loop",
        tip: "Short and functional, not a full-day attraction engine.",
      },
      {
        title: "Black Sea viewpoints",
        tip: "Best if weather behaves and you have transport.",
      },
      {
        title: "Regional food stop",
        tip: "One of the better off-pitch reasons to visit.",
      },
      {
        title: "Stadium approach",
        tip: "Keep it simple and practical.",
      },
      {
        title: "Trabzon pairing",
        tip: "Rize often works better when combined with Trabzon.",
      },
      {
        title: "One- or two-night stay",
        tip: "That is the right scale for most people.",
      },
      {
        title: "Tea-shopping stop",
        tip: "A decent small souvenir angle without nonsense.",
      },
      {
        title: "Slow morning",
        tip: "Rize suits a slower pace.",
      },
    ],
    tips: [
    ...
    topThings: [
      {
        ...
        tip: "Short, practical and enough for most football weekends.",
      },
      {
        title: "Waterfront area",
        tip: "Best for a calmer city feel and easy meals.",
      },
      {
        title: "Local restaurants",
        tip: "Keep expectations practical, not luxury-led.",
      },
      {
        title: "Clock Tower / central landmarks",
        tip: "Fine as short stops, not day-planners.",
      },
      {
        title: "Football-led itinerary",
        tip: "This is the right mentality here.",
      },
      {
        title: "Nearby regional routing",
        tip: "Izmit works best as part of a wider Marmara trip if you have time.",
      },
      {
        title: "Simple overnight stay",
        tip: "Strongest trip shape.",
      },
      {
        title: "Stadium travel dry run",
        tip: "Worth understanding in advance rather than winging it.",
      },
      {
        title: "Coffee stop in centre",
        tip: "Useful reset, not a destination city move.",
      },
      {
        title: "Early start departure city",
        tip: "This city fits practical routing well.",
      },
    ],
    tips: [
  ...
  gaziantep: {
    ...
    topThings: [
      {
        title: "Old City / Bakırcılar Çarşısı",
        tip: "Good for atmosphere and city texture.",
      },
      {
        title: "Baklava mission",
        tip: "Do it properly. This city earns that reputation.",
      },
      {
        title: "Kebab-heavy dinner",
        tip: "A major part of the trip, not an afterthought.",
      },
      {
        title: "Zeugma Mosaic Museum",
        tip: "The obvious high-value culture stop if you want one.",
      },
      {
        title: "Castle area",
        tip: "Short stop, not a full half-day.",
      },
      {
        title: "Pistachio shopping",
        tip: "Makes sense here; doesn’t feel forced.",
      },
      {
        title: "Football-first afternoon",
        tip: "Let the food and match structure the day.",
      },
      {
        title: "One big dinner booking",
        tip: "Better than drifting between average options.",
      },
      {
        title: "Short city-centre walk",
        tip: "Enough to ground the trip.",
      },
      {
        title: "Departure-day food stop",
        tip: "Worth making time for.",
      },
    ],
    tips: [
    ...
    topThings: [
      {
        ...
        tip: "This is the core of the trip mood.",
      },
      {
        title: "Harbour area",
        tip: "Best for evening movement and easy dinner options.",
      },
      {
        title: "Alanya Castle",
        tip: "Worth it if weather is clear and you want a viewpoint moment.",
      },
      {
        title: "Cable car",
        tip: "Easy scenic add-on, not something to overhype.",
      },
      {
        title: "Beach club / slow daytime",
        tip: "A smarter use of time than forcing generic sightseeing.",
      },
      {
        title: "Sea-view dinner",
        tip: "One proper dinner matters here.",
      },
      {
        title: "Football + leisure split day",
        tip: "This is the city’s natural format.",
      },
      {
        title: "Harbour drinks",
        tip: "Good if you want a softer nightlife option.",
      },
      {
        title: "Morning swim / walk",
        tip: "Strong departure-day move in good weather.",
      },
      {
        title: "Regional transfer stop",
        tip: "Fine if pairing with Antalya or wider coast travel.",
      },
    ],
    tips: [
  ...
  ankara: {
    ...
    topThings: [
      {
        title: "Anıtkabir",
        tip: "The obvious headline site and genuinely worth doing if you have time.",
      },
      {
        title: "Kızılay base area",
        tip: "Best practical city anchor for visitors.",
      },
      {
        title: "Çankaya evening",
        tip: "Better restaurants and more polished city rhythm.",
      },
      {
        title: "Ankara Castle area",
        tip: "Fine for a short historic-city layer.",
      },
      {
        title: "Museum visit",
        tip: "Good if you want one structured cultural block.",
      },
      {
        title: "Coffee-heavy afternoon",
        tip: "Ankara suits practical, low-drama city pacing.",
      },
      {
        title: "Football-led day split",
        tip: "Usually the smartest structure here.",
      },
      {
        title: "One proper dinner",
        tip: "Again, better than wandering into average options.",
      },
      {
        title: "Short central walk",
        tip: "Enough to ground the city, not enough to waste hours.",
      },
      {
        title: "Clean one- or two-night stay",
        tip: "Ideal trip shape.",
      },
    ],
    tips: [
    ...
    food: [
      "Classic grills",
      "Central modern restaurants",
      "Casual café chains and local spots",
    ],
    transport:
    ...
    topThings: [
      {
        ...
        tip: "The central attraction and worth doing if you are here.",
      },
      {
        title: "Alaaddin area",
        tip: "Good city-centre anchor.",
      },
      {
        title: "Short old-centre walk",
        tip: "Enough for atmosphere without overextending.",
      },
      {
        title: "Traditional Turkish dinner",
        tip: "Best done properly in one strong sitting.",
      },
      {
        title: "Tea / coffee stop near centre",
        tip: "The city suits slower pauses.",
      },
      {
        title: "Football-first afternoon",
        tip: "Simple structure works well here.",
      },
      {
        title: "One-night cultural add-on",
        tip: "Konya is strong in compact form.",
      },
      {
        title: "Museum / heritage layer",
        tip: "This city actually benefits from one proper history block.",
      },
      {
        title: "Central shopping streets",
        tip: "Useful filler, not the point of the trip.",
      },
      {
        title: "Departure-day calm breakfast",
        tip: "Good city for a low-chaos finish.",
      },
    ],
    tips: [
  ...
  antalya: {
    ...
    topThings: [
      {
        ...
        tip: "Best district for atmosphere and wandering.",
      },
      {
        title: "Harbour / marina area",
        tip: "Best for easy evening views and dinner.",
      },
      {
        title: "Konyaaltı beach",
        tip: "Good if you want the relaxed city-plus-sea angle.",
      },
      {
        title: "Old-town hotel stay",
        tip: "Adds a lot more charm than anonymous resort logic.",
      },
      {
        title: "Boat trip",
        tip: "Fine add-on if weather is right and schedule allows.",
      },
      {
        title: "Roman gate / old walls",
        tip: "Short heritage layer, not a huge time sink.",
      },
      {
        title: "Sunset dinner",
        tip: "One of the better simple wins in the city.",
      },
      {
        title: "Football + beach split day",
        tip: "This is the obvious format.",
      },
      {
        title: "Morning promenade walk",
        tip: "Very strong departure-day move.",
      },
      {
        title: "Hotel-leisure balance",
        tip: "Don’t make the trip overbusy; Antalya doesn’t need that.",
      },
    ],
    tips: [
    ...
    food: [
      "Seafood",
      "Old-town Turkish dining",
      "Beachfront cafés",
      "Hotel breakfast done properly",
    ],
    transport:
    ...
    topThings: [
      {
        ...
        tip: "Best practical city anchor.",
      },
      {
        title: "Castle / central heritage area",
        tip: "Good short stop, not a full day.",
      },
      {
        title: "Pastırma / mantı food angle",
        tip: "The city’s strongest off-pitch asset.",
      },
      {
        title: "Local food mission",
        tip: "One proper meal matters more than generic sightseeing.",
      },
      {
        title: "Simple centre walk",
        tip: "Enough to give the trip shape.",
      },
      {
        title: "Cappadocia extension",
        tip: "The strongest wider-use case if you have time.",
      },
      {
        title: "Football-led overnight",
        tip: "Usually the smartest format.",
      },
      {
        title: "Short history stop",
        tip: "Fine if you need a cultural layer.",
      },
      {
        title: "Morning central coffee",
        tip: "Useful low-effort reset.",
      },
      {
        title: "Airport-friendly departure",
        tip: "A strength of the trip.",
      },
    ],
    tips: [
