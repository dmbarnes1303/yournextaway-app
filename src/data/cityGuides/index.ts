...
import type { CityTopThing } from "./types";
...
export const cityGuides: Record<string, CityGuide> = {
  london: {
    ...
    topThings: [
      { title: "Westminster → South Bank walk", tip: "Go at golden hour. Start at Westminster, finish at Tower Bridge if you’ve got time." },
      { title: "Borough Market", tip: "Avoid peak Saturday lunchtime if you hate queues. Go early or late afternoon and graze." },
      { title: "British Museum", tip: "Pick 3 galleries max. Trying to ‘do it all’ is a waste." },
      { title: "Covent Garden / Soho evening", tip: "Book dinner, then wander—Soho is better unplanned once you’ve got a base." },
      { title: "Greenwich day trip", tip: "Take the Thames Clipper boat one way. It’s transport + sightseeing in one." },
      { title: "Notting Hill & Portobello Road", tip: "Best on market days—weekday mornings are calmer if you want photos." },
      { title: "Skyline viewpoint", tip: "Primrose Hill is free and fast. Paid views are rarely worth it if you’re short on time." },
  ...
  madrid: {
    ...
    topThings: [
      ...
      { title: "Mercado de San Miguel (or alternatives)", tip: "San Miguel is touristy. For better value, try local markets with fewer queues." },
  ...
  rome: {
    ...
    topThings: [
      ...
      { title: "Piazza Navona", tip: "Good for an evening stroll, but don’t eat on the square unless you enjoy paying double." },
  ...
  paris: {
    ...
    topThings: [
      ...
      { title: "Louvre", tip: "Decide your top 5 artworks before you go. Otherwise you’ll just drift and burn out." },
      ...
      { title: "Matchday (Parc des Princes)", tip: "Plan metro in/out and a pre-match food stop—stadium area isn’t where you want to ‘decide on the fly’." },
    ],
    tips: [
