...
const GYG = {
  ...
  aberdeen:
    "https://www.getyourguide.com/en-gb/aberdeen-l93615/?partner_id=MAQJREP&utm_medium=online_publisher",
  dundee:
    "https://www.getyourguide.com/en-gb/dundee-l101346/?partner_id=MAQJREP&utm_medium=online_publisher",
} as const;
...
export const scottishPremiershipCityGuides: Record<string, CityGuide> = {
  glasgow: {
    ...
    topThings: [
      {
        title: "Merchant City → Trongate → city-centre pub route",
        tip: "Best all-round pre-match and evening block if you want atmosphere without overcomplicating logistics.",
      },
      {
        title: "Kelvingrove Museum and west-end loop",
        tip: "High-value daytime option if you want something worthwhile without killing the football rhythm.",
      },
      {
        title: "Finnieston food and bar run",
        tip: "Strongest non-tourist-feeling evening area for a proper Glasgow night.",
      },
      {
        title: "Ashton Lane / west end",
        tip: "Good if you want a polished version of Glasgow nightlife rather than the rougher central-city pub circuit.",
      },
      {
        title: "George Square and central orientation walk",
        tip: "Useful at the start just to get the city shape into your head.",
      },
      {
        title: "Riverside walk and Hydro side",
        tip: "A decent low-effort daytime connector, not a thing to build a whole day around.",
      },
      {
        title: "One proper Glasgow pub session",
        tip: "Do not treat the pubs as afterthoughts. In Glasgow they are part of the football experience.",
      },
      {
        title: "Old Firm or major Glasgow fixture planning",
        tip: "This is where the city goes from good to elite, but planning and timing matter far more.",
      },
      {
        title: "Subway-led stadium day",
        tip: "The city is at its best when you let the compact transport system keep the day simple.",
      },
      {
        title: "Late walk back through the centre",
        tip: "Glasgow nights often feel better when you move between areas rather than locking into one venue too early.",
      },
    ],
  ...
  edinburgh: {
    ...
    topThings: [
      {
        title: "Old Town and Royal Mile loop",
        tip: "Do it once, do it properly, and then move on. Do not spend your whole weekend trapped in tourist flow.",
      },
      {
        title: "Grassmarket pub stretch",
        tip: "Great for atmosphere, but better earlier than late when it gets too obvious and crowded.",
      },
      {
        title: "Calton Hill or Arthur's Seat viewpoint",
        tip: "Pick one. Collecting viewpoints is lazy itinerary writing.",
      },
      {
        title: "Stockbridge brunch or coffee block",
        tip: "Excellent morning-after reset if you stayed out.",
      },
      {
        title: "Leith food and bar run",
        tip: "Best if you want the city to feel less touristy and more lived-in.",
      },
      {
        title: "Haymarket → West End practical base",
        tip: "This is often the smartest football-weekend zone, especially for Hearts.",
      },
      {
        title: "Edinburgh derby planning",
        tip: "One of the best domestic city-derby trips in Britain if timed right.",
      },
      {
        title: "Princes Street Gardens connector walk",
        tip: "Useful for city flow, not a major destination in itself.",
      },
      {
        title: "One proper Scottish pub meal",
        tip: "Worth doing because Edinburgh can become too café-and-snack if you are careless.",
      },
      {
        title: "Nightcap away from the loudest tourist strip",
        tip: "The city improves fast when you step slightly off the obvious routes.",
      },
    ],
  ...
  aberdeen: {
    ...
    topThings: [
      {
        title: "Union Street and central pub route",
        tip: "Best starting spine for understanding the city and building a simple football day.",
      },
      {
        title: "Old Aberdeen short detour",
        tip: "Worth it if you want one distinctly different area without wasting half the day.",
      },
      {
        title: "Harbour or seafront block",
        tip: "Good atmospheric add-on, especially if you want the city to feel less urban-monotone.",
      },
      {
        title: "Pittodrie approach on foot",
        tip: "Useful because the ground itself is part of why you came.",
      },
      {
        title: "One proper pre-match pint circuit",
        tip: "Aberdeen works better when you let the football lead the day instead of hiding it in the schedule.",
      },
      {
        title: "Evening food booking near the centre",
        tip: "Makes the overnight feel deliberate rather than improvised.",
      },
      {
        title: "Compact one-night football stay",
        tip: "Usually the sweet spot. Two nights can work, but one is often enough.",
      },
      {
        title: "Beachfront morning reset",
        tip: "A good next-day cleanser if you had a proper night out.",
      },
      {
        title: "Station-area practicality block",
        tip: "Useful if you are rail-led and want the trip to stay friction-free.",
      },
      {
        title: "Classic northern football-city mindset",
        tip: "That is the right lens for Aberdeen. Do not expect Edinburgh with a different accent.",
      },
    ],
  ...
  dundee: {
    ...
    topThings: [
      {
        title: "Dundee derby context walk",
        tip: "Even if there is no derby on, understanding how close the two grounds are is part of the point of the city.",
      },
      {
        title: "Waterfront and V&A exterior area",
        tip: "Good modern-city contrast to the older football feel.",
      },
      {
        title: "City-centre pub session",
        tip: "Best done simply. Dundee is not a city for over-curated nightlife routes.",
      },
      {
        title: "One ground-area wander before kickoff",
        tip: "Essential here because the football geography is such a big part of the trip.",
      },
      {
        title: "Dundee station to city-core loop",
        tip: "Useful for keeping the trip friction-free if arriving by rail.",
      },
      {
        title: "One practical dinner booking",
        tip: "Dundee improves when you commit to one decent evening anchor.",
      },
      {
        title: "Short waterfront morning reset",
        tip: "A good simple morning-after move.",
      },
      {
        title: "Traditional football-city framing",
        tip: "This city is at its best when you let football be the headline, not the side quest.",
      },
      {
        title: "Compact one-night stay",
        tip: "Usually enough to get the full point of Dundee unless you are specifically hunting both club experiences.",
      },
      {
        title: "Old-school Scottish football stop",
        tip: "That is the right mentality. Dundee is about football texture, not luxury gloss.",
      },
    ],
  ...
  motherwell: {
    ...
    topThings: [
      {
        title: "Fir Park matchday",
        tip: "The entire reason the stop matters. Build around it properly.",
      },
      {
        title: "Simple town-centre practical loop",
        tip: "Enough to give the place context without wasting time.",
      },
      {
        title: "Glasgow-plus-Motherwell split",
        tip: "Usually the smartest move for most visitors.",
      },
      {
        title: "One local pub pre-match",
        tip: "Worth doing because the whole point here is club realism and local feel.",
      },
      {
        title: "Quick overnight stop",
        tip: "Works fine if the football is the sole focus.",
      },
      {
        title: "Station-led easy planning",
        tip: "Useful if you want no drama and minimal wasted time.",
      },
      {
        title: "No-fake-glamour mindset",
        tip: "This stop improves when you stop trying to force it into being something bigger than it is.",
      },
      {
        title: "West-of-Scotland football route building",
        tip: "Motherwell works well when paired with Glasgow fixtures or wider regional planning.",
      },
      {
        title: "One practical dinner",
        tip: "Keep it simple and the trip stays clean.",
      },
      {
        title: "Early return to Glasgow",
        tip: "Often the right call if you want the evening to have more life.",
      },
    ],
  ...
  paisley: {
    ...
    topThings: [
      {
        title: "St Mirren matchday",
        tip: "The only real reason the stop belongs in the route, so treat it as the anchor.",
      },
      {
        title: "Paisley town-centre pub and meal block",
        tip: "Enough to make the trip feel local without pretending Paisley is trying to outshine Glasgow.",
      },
      {
        title: "Airport-to-football convenience plan",
        tip: "One of the strongest use-cases for this stop.",
      },
      {
        title: "Quick overnight football stay",
        tip: "Very efficient if timing matters more than glamour.",
      },
      {
        title: "Glasgow-plus-Paisley split",
        tip: "Usually the smartest overall option for visitors.",
      },
      {
        title: "One practical local pint",
        tip: "Worth doing because the club’s local context matters.",
      },
      {
        title: "Short station-area planning",
        tip: "Keeps the stop friction-free if you are moving fast.",
      },
      {
        title: "No-nonsense west-Scotland football routing",
        tip: "Paisley is good precisely because it does not need to be overcomplicated.",
      },
      {
        title: "Arrival-day or departure-day football",
        tip: "One of the best Scottish stops for this exact purpose.",
      },
      {
        title: "Simple football-first pacing",
        tip: "That is the right way to handle Paisley.",
      },
    ],
  ...
  kilmarnock: {
    ...
    topThings: [
      {
        title: "Rugby Park matchday",
        tip: "The reason to come. The football is the headline here.",
      },
      {
        title: "Town-centre practical walk",
        tip: "Enough to understand the place without inventing fake attractions.",
      },
      {
        title: "One proper pre-match pub",
        tip: "Important because old-club stops work better when they feel rooted locally.",
      },
      {
        title: "West-of-Scotland football pairing",
        tip: "Kilmarnock works better when linked intelligently with Glasgow or another regional stop.",
      },
      {
        title: "One-night football stay",
        tip: "Usually enough unless you have a very specific extra reason to linger.",
      },
      {
        title: "Glasgow-base alternative",
        tip: "Still the stronger move if nightlife matters more than local immersion.",
      },
      {
        title: "Traditional-club framing",
        tip: "This stop is about football history and local texture, not city glamour.",
      },
      {
        title: "Simple local meal block",
        tip: "Keep it clean and practical.",
      },
      {
        title: "Rail-led easy movement",
        tip: "Useful if you want the whole trip to stay low-drama.",
      },
      {
        title: "No-overplanning football stop",
        tip: "That is how Kilmarnock is best used.",
      },
    ],
  ...
  falkirk: {
    ...
    topThings: [
      {
        title: "Falkirk matchday",
        tip: "The clear anchor. This stop only makes sense when the football is treated as the point.",
      },
      {
        title: "Simple station-to-town practical route",
        tip: "Good for keeping the trip clean and easy.",
      },
      {
        title: "One local pub block",
        tip: "Enough to give the place character without overdoing it.",
      },
      {
        title: "Central-Scotland football routing",
        tip: "Where Falkirk becomes especially useful.",
      },
      {
        title: "Short football overnight",
        tip: "Often enough if the fixture is the headline.",
      },
      {
        title: "Glasgow or Edinburgh split-base option",
        tip: "Valid if you want a broader city layer on top of the football.",
      },
      {
        title: "No-fuss football stop",
        tip: "That is the correct mindset here.",
      },
      {
        title: "One proper pre-match meal",
        tip: "Helpful because a clean anchor improves smaller-town trips a lot.",
      },
      {
        title: "Ambitious-club context framing",
        tip: "This is part of why Falkirk are interesting compared with more anonymous stops.",
      },
      {
        title: "Low-drama transport planning",
        tip: "One of the practical strengths of the stop.",
      },
    ],
    ...
    transport:
      "Falkirk’s big strength is location. It is easy enough to fit into wider Scott1ish travel if you plan sensibly. Once there, the stop should remain practical rather than complicated.",
  ...
  livingston: {
    ...
    topThings: [
      {
        title: "Livingston matchday",
        tip: "The only real reason the stop exists in the route — so treat it as the point.",
      },
      {
        title: "Practical overnight near the ground or town core",
        tip: "Useful if convenience is your top priority.",
      },
      {
        title: "Glasgow / Edinburgh split-base option",
        tip: "Often smarter if you want actual nightlife or city atmosphere on the same trip.",
      },
      {
        title: "One simple pre-match pub or meal",
        tip: "Enough to structure the day without pretending there is more to squeeze from the town than there is.",
      },
      {
        title: "Rail-and-road logistics play",
        tip: "This is where Livingston is strongest: convenience, not glamour.",
      },
      {
        title: "No-fake-romance football stop",
        tip: "Exactly the right mindset for this city.",
      },
      {
        title: "Short football detour in a wider Scotland route",
        tip: "Very valid use-case.",
      },
      {
        title: "Quick post-match exit strategy",
        tip: "Good if you are using it as a branch trip from a bigger city.",
      },
      {
        title: "One-night match-focused stop",
        tip: "Enough for most people.",
      },
      {
        title: "Modern-club context stop",
        tip: "Useful if you care about understanding the full shape of Scottish football, not just the heritage clubs.",
      },
    ],
