...
const GYG = {
  ...
  "cluj-napoca":
    "https://www.getyourguide.com/en-gb/cluj-napoca-l2393/?partner_id=MAQJREP&utm_medium=online_publisher",
  craiova:
    "https://www.getyourguide.com/en-gb/craiova-l151164/?partner_id=MAQJREP&utm_medium=online_publisher",
  sibiu:
    "https://www.getyourguide.com/en-gb/sibiu-l1833/?partner_id=MAQJREP&utm_medium=online_publisher",
  constanta:
    "https://www.getyourguide.com/en-gb/constanta-l2661/?partner_id=MAQJREP&utm_medium=online_publisher",
} as const;
...
export const superLigaCityGuides: Record<string, CityGuide> = {
  bucharest: {
    ...
    topThings: [
      {
        title: "Old Town evening block",
        tip: "Best used as a drinks-and-dinner zone, not as your entire view of Bucharest.",
      },
      {
        title: "Calea Victoriei walk",
        tip: "One of the cleanest daytime routes for architecture, cafés, and a more polished city feel.",
      },
      {
        title: "Palace of the Parliament",
        tip: "Worth seeing for scale alone, but don’t let one mega-building eat half your day.",
      },
      {
        title: "Romanian Athenaeum area",
        tip: "Strong elegant central stop that pairs well with Victoriei wandering.",
      },
      {
        title: "Herăstrău / King Michael I Park",
        tip: "Best daylight reset if you want green space before a night match.",
      },
      {
        title: "Local beer hall or grill house",
        tip: "Good match-weekend move if you want something more grounded than tourist-strip dining.",
      },
      {
        title: "Arena Națională exterior approach",
        tip: "Arrive early in big-match settings — the scale reads far better when you’re not rushing.",
      },
      {
        title: "Giulești / club-neighbourhood contrast",
        tip: "Useful if you want to feel how different Bucharest’s football identities are, not just see one generic capital.",
      },
      {
        title: "Evening boulevard walk",
        tip: "Bucharest often feels better after dark than in the middle of a hot, traffic-heavy afternoon.",
      },
      {
        title: "One proper café session",
        tip: "The city’s café culture is part of the product, not wasted time between football stops.",
      },
    ],
  ...
  "cluj-napoca": {
    ...
    topThings: [
      {
        title: "Union Square / central old core",
        tip: "The obvious starting point and still the correct one.",
      },
      {
        title: "Central Park",
        tip: "A very easy daylight reset before heading toward the stadium zones.",
      },
      {
        title: "Cluj Arena surroundings",
        tip: "Good sports-district feel and a useful pre-match orientation walk.",
      },
      {
        title: "Old Town restaurant circuit",
        tip: "Best to book one strong dinner rather than bounce between average places.",
      },
      {
        title: "Student-heavy bar streets",
        tip: "Cluj’s younger energy is part of what makes the city feel alive at night.",
      },
      {
        title: "Matthias Corvinus / central landmark loop",
        tip: "Works well as a short architecture-and-coffee block.",
      },
      {
        title: "Riverside or park-side walking",
        tip: "Useful if you want the trip to breathe between meals and football.",
      },
      {
        title: "Pre-match central drinks",
        tip: "Cluj handles this better than trying to improvise around the grounds.",
      },
      {
        title: "Night square return",
        tip: "The centre usually looks and feels better after dark.",
      },
      {
        title: "Slow morning café reset",
        tip: "Strong city for a calm day-after recovery before travel home.",
      },
    ],
  ...
  craiova: {
    ...
    topThings: [
      {
        title: "Ion Oblemenco Stadium exterior and approach",
        tip: "One of the city’s headline assets — arrive early and take it in properly.",
      },
      {
        title: "Nicolae Romanescu Park",
        tip: "Best daylight reset if you want a break from urban matchday rhythm.",
      },
      {
        title: "Old Town dining zone",
        tip: "Small enough to stay efficient, lively enough to work for dinner and drinks.",
      },
      {
        title: "Art Museum / palace area",
        tip: "Good if you want a short culture block without burning the whole day.",
      },
      {
        title: "Central square and pedestrian streets",
        tip: "Use them for orientation and a relaxed pre-match wander.",
      },
      {
        title: "University district feel",
        tip: "Adds a bit of youth and movement to the city beyond football.",
      },
      {
        title: "Pre-match café session",
        tip: "Craiova works better when you keep the build-up calm and central.",
      },
      {
        title: "One strong traditional dinner",
        tip: "Better than picking at random around the stadium zone.",
      },
      {
        title: "Evening central walk",
        tip: "The city centre reads best once it cools down and lights come on.",
      },
      {
        title: "Morning-after local bakery or coffee stop",
        tip: "Good low-friction finish to a football-led overnight.",
      },
    ],
  ...
  sibiu: {
    ...
    topThings: [
      {
        title: "Large Square",
        tip: "The natural centrepoint for almost every Sibiu weekend plan.",
      },
      {
        title: "Bridge of Lies",
        tip: "Touristy, yes — still worth doing because it fits the old town flow perfectly.",
      },
      {
        title: "Old Town street wander",
        tip: "Best done slowly rather than turned into a rushed checklist.",
      },
      {
        title: "Council Tower viewpoint",
        tip: "Good short effort-to-reward ratio if you want a city overview.",
      },
      {
        title: "Traditional Transylvanian dinner",
        tip: "One properly chosen meal goes further here than several average ones.",
      },
      {
        title: "Old Town evening drinks",
        tip: "Sibiu suits calm quality over chaotic nightlife.",
      },
      {
        title: "Pre-match central coffee block",
        tip: "A strong city for low-pressure build-up before kickoff.",
      },
      {
        title: "Local squares after dark",
        tip: "The old centre has a properly atmospheric evening feel.",
      },
      {
        title: "Morning pastry and coffee",
        tip: "Very strong place for a calm second-day rhythm.",
      },
      {
        title: "Short culture stop",
        tip: "Pick one museum or church at most unless history is your main priority.",
      },
    ],
  ...
  constanta: {
    ...
    topThings: [
      {
        title: "Constanța Casino seafront area",
        tip: "The city’s iconic visual anchor and still the right place to start.",
      },
      {
        title: "Black Sea waterfront walk",
        tip: "Best at golden hour or early evening.",
      },
      {
        title: "Old Town core",
        tip: "Worth doing, but do not expect it to carry the whole weekend by itself.",
      },
      {
        title: "Mamaia add-on",
        tip: "Useful if you want nightlife or a more resort-style extension in season.",
      },
      {
        title: "Seafood dinner",
        tip: "This is one city where the meal choice genuinely shapes the quality of the trip.",
      },
      {
        title: "Harbour district feel",
        tip: "Adds some working-city reality beyond the resort image.",
      },
      {
        title: "Pre-match drink by the sea",
        tip: "One of the nicest football build-ups in the league if the weather is good.",
      },
      {
        title: "Beach or promenade reset",
        tip: "Best used as a low-pressure second-day block.",
      },
      {
        title: "Morning coastal coffee",
        tip: "Excellent calm start after a later night.",
      },
      {
        title: "Farul matchday plan",
        tip: "Treat the stadium move as one simple transfer from the coast-side base.",
      },
    ],
    ...
    topThings: [
      {
        ...
        tip: "Enough for orientation, food, and a sense of place without pretending the city is endless.",
      },
      {
        title: "Nicolae Dobrin football context",
        tip: "The club identity matters more than trying to force a tourist-heavy narrative.",
      },
      {
        title: "Local restaurant stop",
        tip: "One decent meal is enough to anchor the evening.",
      },
      {
        title: "Central café session",
        tip: "Useful low-effort downtime before or after travel.",
      },
      {
        title: "Park or boulevard wander",
        tip: "Good if you want a short reset before matchday.",
      },
      {
        title: "Pre-match planning block",
        tip: "This trip works best when logistics are decided early.",
      },
      {
        title: "Short evening in the centre",
        tip: "Keep expectations realistic and it’s perfectly fine.",
      },
      {
        title: "One-night football stay",
        tip: "This is the cleanest way to frame the city.",
      },
      {
        title: "Morning coffee before departure",
        tip: "Good low-friction end to the trip.",
      },
      {
        title: "Mioveni linkage if needed",
        tip: "Important if the club is not using its natural long-term home context.",
      },
    ],
  ...
  arad: {
    ...
    topThings: [
      {
        title: "Central Arad architecture walk",
        tip: "The city’s Habsburg-era feel is one of its better surprises.",
      },
      {
        title: "Theatre quarter / central boulevards",
        tip: "Best area for the city’s more elegant urban feel.",
      },
      {
        title: "Mureș river area",
        tip: "Useful for a calmer pre-match or morning walk.",
      },
      {
        title: "Arena Francisc Neuman approach",
        tip: "A modern ground that improves the trip a lot.",
      },
      {
        title: "One proper dinner in the centre",
        tip: "Better than wandering aimlessly for food after dark.",
      },
      {
        title: "Local café stop",
        tip: "Arad suits a measured pace more than overstacked planning.",
      },
      {
        title: "Evening centre wander",
        tip: "Good city for a simple night rather than a huge one.",
      },
      {
        title: "Pre-match central drinks",
        tip: "Usually the cleanest formula here.",
      },
      {
        title: "Morning bakery or coffee",
        tip: "Works well as a tidy end to the trip.",
      },
      {
        title: "Timișoara linkage if routing wider",
        tip: "Useful if you are building a broader western Romania trip.",
      },
    ],
  ...
  botosani: {
    ...
    topThings: [
      {
        title: "Central Botoșani walk",
        tip: "Useful for orientation and enough for a small-city feel.",
      },
      {
        title: "Old-centre café stop",
        tip: "A practical anchor before or after matchday.",
      },
      {
      ...
      {
        title: "Stadionul Municipal approach",
        tip: "Football is clearly the main reason you’re here.",
      },
      {
        title: "Morning square loop",
        tip: "Good if you are staying one night and leaving the next day.",
      },
      {
        title: "Short local shopping streets",
        tip: "Useful filler, not a headline attraction.",
      },
      {
        title: "Pre-match food plan",
        tip: "Decide it early rather than relying on late improvisation.",
      },
      {
        title: "One-night football framing",
        tip: "The correct way to think about the city.",
      },
      {
        title: "Regional route linkage",
        tip: "Best if you are building a broader north-east Romania trip.",
      },
      {
        title: "Simple coffee-and-go exit",
        tip: "Low-friction departures suit this kind of stop.",
      },
    ],
  ...
  galati: {
    ...
    topThings: [
      {
        title: "Danube-front walk",
        tip: "The city’s best simple visual asset and a useful reset block.",
      },
      {
        title: "Central Galați loop",
        tip: "Enough for food, orientation, and a feel for the city.",
      },
      {
        title: "Oțelul matchday build-up",
        tip: "The football identity is the main point here.",
      },
      {
        title: "River-adjacent dinner",
        tip: "Best way to give the trip some atmosphere beyond the stadium.",
      },
      {
        title: "Local café stop",
        tip: "Useful in a city that works better slowly than through overplanning.",
      },
      {
        title: "Pre-match simple meal",
        tip: "Sort it centrally before heading out.",
      },
      {
        title: "Short evening in the centre",
        tip: "Keep expectations realistic and it works fine.",
      },
      {
        title: "Morning Danube coffee",
        tip: "Good low-pressure start before travel.",
      },
      {
        title: "Regional Brăila linkage",
        tip: "Useful if you are shaping a broader lower-Danube route.",
      },
      {
        title: "Committed overnight framing",
        tip: "This is not the easiest Romanian trip, but that’s part of the point.",
      },
    ],
  ...
  ploiesti: {
    ...
    topThings: [
      {
        title: "Ilie Oană matchday approach",
        tip: "The stadium and club atmosphere are the main reason the trip works.",
      },
      {
        title: "Central Ploiești walk",
        tip: "Useful for orientation, not for endless discovery.",
      },
      {
        title: "Local restaurant dinner",
        tip: "Best done centrally and without overthinking it.",
      },
      {
        title: "Short central café stop",
        tip: "Good pre-match time filler if kept simple.",
      },
      {
        title: "One-night football stay",
        tip: "The correct framing for most visitors.",
      },
      {
        title: "Morning bakery or coffee",
        tip: "Low-effort but effective end to the trip.",
      },
      {
        title: "Pre-match pub or bar",
        tip: "Worth doing if you want a more club-led feel to the day.",
      },
      {
        title: "Simple evening route",
        tip: "Ploiești is better handled cleanly than overpacked.",
      },
      {
        title: "Bucharest linkage",
        tip: "Useful if building a wider Romania route.",
      },
      {
        title: "Football-over-tourism mindset",
        tip: "Important here — the trip improves when framed honestly.",
      },
    ],
  ...
  "miercurea-ciuc": {
    ...
    topThings: [
      {
        title: "Compact town-centre loop",
        tip: "Enough to understand the place without pretending it is huge.",
      },
      {
        title: "Local café or pastry stop",
        tip: "Simple, useful, and appropriate for the town’s scale.",
      },
      {
        title: "Municipal stadium approach",
        tip: "The match is clearly the anchor here.",
      },
      {
        title: "Short evening in the centre",
        tip: "Keep expectations aligned and it works well enough.",
      },
      {
        title: "Regional atmosphere absorb-and-go",
        tip: "Part of the appeal is just feeling a different football geography.",
      },
      {
        title: "One-night football framing",
        tip: "The correct way to structure this trip.",
      },
      {
        title: "Morning coffee before departure",
        tip: "Useful low-friction finish.",
      },
      {
        title: "Cool-weather realism",
        tip: "Dress properly — conditions matter more here.",
      },
      {
        title: "Rail linkage planning",
        tip: "Important because the town is not a lazy spontaneous add-on.",
      },
      {
        title: "Regional Transylvania extension",
        tip: "Best if folded into a wider route.",
      },
    ],
  ...
  slobozia: {
    ...
    topThings: [
      {
        title: "Central Slobozia loop",
        tip: "Enough for orientation and a basic town feel.",
      },
      {
        title: "Short pre-match meal",
        tip: "Decide it early and keep expectations simple.",
      },
      {
        title: "Local café stop",
        tip: "Useful for low-friction downtime.",
      },
      {
        title: "Stadionul 1 Mai approach",
        tip: "Football is clearly the main event here.",
      },
      {
        title: "One-night practical stay",
        tip: "This is the natural product.",
      },
      {
        title: "Morning coffee and exit",
        tip: "Best clean finish to the trip.",
      },
      {
        title: "Bucharest linkage",
        tip: "Important for broader route planning.",
      },
      {
        title: "No-overcomplication rule",
        tip: "Critical in a place like this.",
      },
      {
        title: "Simple town-centre dinner",
        tip: "Good enough if framed properly.",
      },
      {
        title: "Match-first scheduling",
        tip: "The city does not need padding to work.",
      },
    ],
