...
export const hnlCityGuides: Record<string, CityGuide> = {
  zagreb: {
    ...
    topThings: [
      {
        title: "Ban Jelačić Square and central core",
        tip: "Use this as your anchor, not as your whole day.",
      },
      {
        title: "Upper Town walk",
        tip: "Best done in daylight when the city reads clearly.",
      },
      {
        title: "Tkalčićeva Street",
        tip: "Strong café and bar strip, especially late afternoon into evening.",
      },
      {
        title: "Dolac Market",
        tip: "Go earlier, before it becomes more symbolic than useful.",
      },
      {
        title: "Maksimir Park",
        tip: "Excellent reset before a match if you want air and space.",
      },
      {
        title: "Museum block",
        tip: "Pick one or two; don’t over-collect indoor stops.",
      },
      {
        title: "Craft beer / local wine evening",
        tip: "Zagreb does relaxed nights well if you don’t force them.",
      },
      {
        title: "Daytime café session",
        tip: "The city’s café rhythm is part of the culture, not dead time.",
      },
      {
        title: "Pre-match tram plan",
        tip: "Sort it in advance and the whole day stays easy.",
      },
      {
        title: "Post-match central return",
        tip: "Usually better than lingering too long around the ground.",
      },
    ],
    tips: [
    ...
    topThings: [
      {
        ...
        tip: "Walk it repeatedly at different times instead of trying to ‘finish’ it once.",
      },
      {
        title: "Riva waterfront",
        tip: "The city’s social spine. Best around late afternoon and evening.",
      },
      {
        title: "Marjan Hill",
        tip: "Best daylight reset and view play if you want some balance.",
      },
      {
        title: "Bačvice area",
        tip: "Useful if you want a beach-plus-city rhythm.",
      },
      {
        title: "Local seafood meal",
        tip: "This is not the city for a lazy chain dinner.",
      },
      {
        title: "Coffee and slow morning",
        tip: "Split suits a slower start before ramping up later.",
      },
      {
        title: "Poljud exterior approach",
        tip: "Arrive early. The setting matters.",
      },
      {
        title: "Harbour / ferry zone walk",
        tip: "Good orientation point if arriving by bus or ferry.",
      },
      {
        title: "Night drinks in the old core",
        tip: "Strong atmosphere, but choose a couple of good places not ten average ones.",
      },
      {
        title: "Sunday low-pressure seafront block",
        tip: "A clean finish to the weekend.",
      },
    ],
    tips: [
  ...
  rijeka: {
    ...
    topThings: [
      {
        title: "Korzo",
        tip: "Use it as the city’s movement spine, not a destination in itself.",
      },
      {
        title: "Trsat Castle",
        tip: "One of the best viewpoint moves in the city.",
      },
      {
        title: "Port and waterfront zones",
        tip: "Part of the city’s identity even if not all of it is picturesque.",
      },
      {
        title: "Central café and bar block",
        tip: "Rijeka is better at relaxed urban rhythm than hard tourist spectacle.",
      },
      {
        title: "Opatija add-on",
        tip: "Strong if you want a more polished coastal layer nearby.",
      },
      {
        title: "Market / local produce stop",
        tip: "Useful in the morning before the day sprawls.",
      },
      {
        title: "Pre-match city-centre meal",
        tip: "Usually better than trying to improvise around the ground.",
      },
      {
        title: "Rujevica trip plan",
        tip: "Treat it as one purposeful move.",
      },
      {
        title: "Evening drinks",
        tip: "Rijeka is best when you let the city feel lived-in rather than hyper-curated.",
      },
      {
        title: "Kvarner coast extension",
        tip: "Worth it if you have extra time.",
      },
    ],
    tips: [
    ...
    topThings: [
      {
        ...
        tip: "Enough for orientation and a meal, not for a sprawling itinerary.",
      },
      {
        title: "Local café stop",
        tip: "Best done simply rather than overplanned.",
      },
      {
        title: "Town square / centre",
        tip: "Use it as your anchor.",
      },
      {
        title: "Pre-match local food",
        tip: "Sort this early and keep the day easy.",
      },
      {
        title: "Rail arrival block",
        tip: "If arriving by train, keep the logistics tight.",
      },
      {
        title: "Simple overnight",
        tip: "This is the honest product here.",
      },
      {
        title: "Zagreb-linked route",
        tip: "Usually the smartest wider-trip framing.",
      },
      {
        title: "Morning coffee exit plan",
        tip: "Useful if treating it as a one-night stop.",
      },
      {
        title: "Match-first schedule",
        tip: "Don’t overdecorate the trip.",
      },
      {
        title: "Regional northern Croatia route",
        tip: "Where it makes most sense.",
      },
    ],
    tips: [
    ...
    topThings: [
      {
        ...
        tip: "The city’s main asset. Walk it properly instead of rushing.",
      },
      {
        title: "Castle / historic core",
        tip: "Good for light sightseeing without wasting the day.",
      },
      {
        title: "Main square café session",
        tip: "Best used as part of the city rhythm.",
      },
      {
        title: "Short museum / church loop",
        tip: "Only if you want some cultural depth.",
      },
      {
        title: "Pre-match meal in the centre",
        tip: "This is the obvious move.",
      },
      {
        title: "Evening walk",
        tip: "Varaždin suits a calm football overnight.",
      },
      {
        title: "Local bakery breakfast",
        tip: "Good low-effort morning plan.",
      },
      {
        title: "Matchday walkability",
        tip: "One of the city’s strengths.",
      },
      {
        title: "Zagreb add-on",
        tip: "Easy enough if combining cities.",
      },
      {
        title: "One-night reset city",
        tip: "That is where it excels.",
      },
    ],
    tips: [
  ...
  pula: {
    ...
    topThings: [
      {
        title: "Pula Arena",
        tip: "The obvious landmark and worth seeing properly.",
      },
      {
        title: "Old Town / Roman core",
        tip: "Best explored casually, not with rigid checklists.",
      },
      {
        title: "Harbour and waterfront",
        tip: "Useful as part of the city flow rather than a standalone attraction.",
      },
      {
        title: "Coastal swim / sea block",
        tip: "A big part of why Pula works.",
      },
      {
        title: "Seafood dinner",
        tip: "The city is too good for lazy food choices.",
      },
      {
        title: "Aldo Drosina approach",
        tip: "Keep matchday movement simple from the centre.",
      },
      {
        title: "Morning coffee in the old core",
        tip: "Strong slow-start city.",
      },
      {
        title: "Nearby beaches",
        tip: "Worth it if the weather is right.",
      },
      {
        title: "Evening drinks",
        tip: "Pula is more relaxed than Split, which suits some travellers better.",
      },
      {
        title: "Istria extension",
        tip: "Huge upside if you have time.",
      },
    ],
    tips: [
  ...
  "velika-gorica": {
    ...
    topThings: [
      {
        title: "Simple centre loop",
        tip: "Enough to orient yourself, not enough for a full city fantasy.",
      },
      {
        title: "Pre-match meal",
        tip: "Keep it practical and early.",
      },
      {
        title: "Airport-linked overnight",
        tip: "A real use case here.",
      },
      {
        title: "Zagreb side trip",
        tip: "Usually the smarter broader trip move.",
      },
      {
        title: "Short local café stop",
        tip: "Low-fuss is the point.",
      },
      {
        title: "Match-first planning",
        tip: "This should be a simple day.",
      },
      {
        title: "Late arrival / early departure utility",
        tip: "One of the city’s real strengths.",
      },
      {
        title: "Rail/bus planning",
        tip: "Keep connections clean.",
      },
      {
      ...
      {
        title: "Zagreb return after match",
        tip: "Usually the correct decision.",
      },
    ],
    tips: [
  ...
  osijek: {
    ...
    topThings: [
      {
        title: "Tvrđa",
        tip: "Best historical and atmospheric zone in the city.",
      },
      {
        title: "Drava riverfront",
        tip: "Excellent simple walk that makes the city feel open and easy.",
      },
      {
        title: "Centre cafés",
        tip: "Osijek suits a slower café-led rhythm.",
      },
      {
        title: "Opus Arena plan",
        tip: "Treat matchday as one deliberate move from the centre.",
      },
      {
        title: "Evening drinks in Tvrđa",
        tip: "Best if you want the city to feel alive without chaos.",
      },
      {
        title: "Morning river walk",
        tip: "Strong reset before travel.",
      },
      {
        title: "Good local dinner",
        tip: "Worth doing properly rather than lazily.",
      },
      {
        title: "Short museum or cultural block",
        tip: "Useful if you have extra time.",
      },
      {
        title: "Tram / local transport use",
        tip: "Keeps the city easy.",
      },
      {
        title: "Slavonia extension",
        tip: "Real upside if building a longer route.",
      },
    ],
    tips: [
    ...
    topThings: [
      {
        ...
        tip: "A simple walk that gives the city context quickly.",
      },
      {
        title: "Memorial / history sites",
        tip: "Only do this properly if you are willing to approach it seriously.",
      },
      {
        title: "Town-centre orientation loop",
        tip: "Enough to understand the city’s scale and feel.",
      },
      {
        title: "Pre-match simple meal",
        tip: "Keep the day straightforward.",
      },
      {
        title: "Football-first visit",
        tip: "This is the cleanest way to frame it unless staying longer for historical reasons.",
      },
      {
        title: "Morning coffee block",
        tip: "Useful if staying one night.",
      },
      {
        title: "Osijek pairing",
        tip: "Usually the strongest broader-trip structure.",
      },
      {
        title: "Quiet evening approach",
        tip: "The city suits seriousness more than forced nightlife.",
      },
      {
        title: "Matchday planning",
        tip: "Keep logistics simple and respectful.",
      },
      {
        title: "Context over quantity",
        tip: "Do fewer things properly here.",
      },
    ],
    tips: [
