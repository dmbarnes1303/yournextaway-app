...
/**
 * Centralised background map.
 *
 * Policy:
 * - Prefer local images (bundled in the repo) where you want guaranteed look/feel.
 * - Remote URLs are fine for placeholders, but expect tone/colour variance.
 */
const BACKGROUNDS: Record<BackgroundKey, any> = {
  // Keep existing remote placeholders until you replace them one by one.
  ...
  // Switched to your local asset (GitHub / repo)
  profile: require("@/src/eiffeltower.jpeg"),
 ...
 */
export function getBackground(key: BackgroundKey) {
