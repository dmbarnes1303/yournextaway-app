    ...
    () => [
      {
        ...
        body: "Browse upcoming matches across top leagues and open a match for details.",
      },
      {
        title: "Build a trip",
        body: "Select a match, then save it as a trip. Add notes and dates in seconds.",
      },
      {
        title: "Keep it simple",
        body: "This build prioritises speed and reliability. Fancy stuff comes later.",
      },
    ],
    []
  );
